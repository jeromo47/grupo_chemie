# Mapa maestro de productos químicos Chemie v2
...
Pretende dejar un **mapa prudente y gobernable** del núcleo fuerte inicial y de una segunda tanda funcional muy útil para completar familias.
...
- **Riesgo de confusión**: alto, porque no conviene llamarlo automáticamente biocida o tratamiento de aguas sin cerrar antes el contexto de uso
...
- **Riesgo de confusión**: medio, sobre todo si se mezclara indebidamente con desinfectantes o biocidas
- **Estado actual de confianza**: **alto**
- **Dudas abiertas**:
  - sectores/clientes concretos de mayor uso
...
- **Dosificación o modo de uso si consta**: **no consta en la ficha resumida aquí**
- **Especificaciones técnicas visibles**:
  - pH aprox. 5,5
...
- **Riesgo de confusión**: alto si se tratara como detergente general o desinfectante, porque parece más bien auxiliar técnico postlavado
...
- **Riesgo de confusión**: alto si se mete en el mismo saco que detergentes o desinfectantes; es otra familia completamente distinta
...
- **Riesgo de confusión**: medio, sobre todo con ALICLOR, porque ambos son clorados pero no parecen ocupar exactamente el mismo papel
- **Estado actual de confianza**: **alto**
- **Dudas abiertas**:
  - usos sectoriales concretos hoy
...
- **Riesgo de confusión**: medio-alto, porque no debe rebajarse a simple detergente ni sobregeneralizarse sin mirar el uso concreto
- **Estado actual de confianza**: **alto**
- **Dudas abiertas**:
...
- **Riesgo de confusión**: alto si se identifica automáticamente como desinfectante solo por la hoja previa “clorado”; la FDS pesa más y lo acerca a detergente técnico fuerte
- **Estado actual de confianza**: **alto**
- **Dudas abiertas**:
...
- **Riesgo de confusión**: medio, sobre todo si se mezcla con higienizantes fuertes o con geles hidroalcohólicos de otra lógica
- **Estado actual de confianza**: **medio**
- **Dudas abiertas**:
  - FDS completa
  - peso comercial real
...
- **Riesgo de confusión**: medio, sobre todo si se sobredimensiona como producto alimentario especializado o como línea sensible
...
- **Encaje eco si consta**: **no consta**
- **Marco regulatorio prudente**: limpieza general / REACH-CLP básico, FDS pendiente
- **Riesgo de confusión**: bajo-medio; más bien conviene no inflarlo como pieza sensible cuando parece producto comercial de mantenimiento
- **Estado actual de confianza**: **medio-bajo**
- **Dudas abiertas**:
  - FDS completa
...
- **Riesgo de confusión**: medio, porque puede mezclarse mentalmente con detergentes cuando en realidad su lógica química es otra
- **Estado actual de confianza**: **alto**
- **Dudas abiertas**:
...
- **Encaje eco si consta**: **no consta expresamente en lo revisado aquí**
- **Marco regulatorio prudente**: posible auxiliar/coadyuvante de proceso alimentario; FDS pendiente
- **Riesgo de confusión**: alto si se simplifica como simple detergente, porque parece pieza mucho más específica de proceso
- **Estado actual de confianza**: **medio-alto**
- **Dudas abiertas**:
  - FDS completa
...
## Lecturas útiles que deja ya esta v2

### 1. El catálogo fuerte ya se abre en al menos cinco grandes carriles
- **oxidantes / higienizantes sensibles** -> OXISAN
- **desengrase y limpieza industrial** -> CHEMGRAS DS, TUNELIMP
- **clorados de limpieza/blanqueo o desinfección** -> ACTIV CLOR, ALICLOR
...
- **auxiliares técnicos alimentarios de alta pureza** -> V-80

### 2. La parte “alimentaria” interna no es homogénea
Dentro del eje alimentario conviene distinguir al menos:
...
- auxiliares técnicos de contacto alimentario -> V-80

### 3. La sensibilidad regulatoria tampoco es homogénea
- **alta/sensible**: OXISAN, ALICLOR
- **alta pero más simple**: ACTIV CLOR, TUNELIMP, CHEMGRAS, NETIND
- **media o parcial por falta de FDS**: HIDROBRILL, TR-20, DERGEL SO
- **más comercial/mantenimiento**: BRINET BQ, BRINET AML

### 4. “Eco” sigue siendo un campo muy restringido
En lo trabajado hasta aquí, la única conexión fuerte ya integrada con el eje eco/CAAE sigue siendo **OXISAN**.
En el resto, si no consta, debe quedar como **no consta**.

### 5. La dosificación sigue siendo hueco crítico
Este campo empieza a ser importante para el mapa real de uso.
Pero justo por eso conviene mantener la disciplina:
- **no poner dosificación si no consta documentalmente**

---

## Conclusión ejecutiva
Con esta v2 el mapa ya deja de ser una lista de referencias y empieza a parecerse a una cartografía funcional seria del catálogo químico de Chemie.

La idea clave sería esta:

> **Para entender el negocio químico de Chemie no basta con saber si un producto limpia o desinfecta; hace falta separar familias, aplicaciones, soporte documental, sensibilidad regulatoria, encaje alimentario y, solo cuando conste, dosificación y posible compatibilidad eco.**

---

## Siguiente tramo recomendado
La siguiente tanda con más retorno sería más selectiva:
- **CHEMGRAS BAC**
- **BACTER CHEM**
- **IBERFARM L**
- **LICOGEL**
...
Antes de abrir toda esa tanda completa, probablemente compensa priorizar primero:
1. **CHEMGRAS BAC**
2. **IBERFARM L**
3. **LICOGEL**
4. **TUNELIMP CL**

Porque son los que más pueden añadir una familia o matiz nuevo al mapa maestro.
